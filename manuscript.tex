...
\tdplotsetmaincoords{60}{125} % view angle in spherical coordinates
 ...
 \author{
  Shankar Kulumani%
    \thanks{Doctoral Candidate, \href{mailto:skulumani@gwu.edu}{skulumani@gwu.edu}.}
  \ and Taeyoung Lee\thanks{Associate Professor, \href{mailto:tylee@gwu.edu}{tylee@gwu.edu}.}\\
  {\normalsize\itshape
