...
Instead, we model the asteroid as a constant-density polyhedron and avoid the issues of the harmonic expansion.
...
Similarly, we also add another Lagrange multipler, \( \beta \in \R^{5 \times 1}\), to account for this additonal terminal constraint.
